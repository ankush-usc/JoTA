...
cmd_to_execute = "/home/hadoop/bin/hadoop jar /home/hadoop/contrib/streaming/hadoop-streaming.jar -files s3://jotabucket/mapperreducers/mapper_skill2.py,s3://jotabucket/mapperreducers/reducer_skill.py -mapper mapper_skill.py -reducer reducer_skill.py -input s3://jotabucket/input1/ -output s3://jotabucket/output1/";
